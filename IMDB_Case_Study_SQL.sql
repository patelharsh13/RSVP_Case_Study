...
-- Total number of rows in director_mapping = 14662

SELECT COUNT(*) FROM movie;
-- Total number of rows in director_mapping = 7997

SELECT COUNT(*) FROM names;
-- Total number of rows in director_mapping = 25735

SELECT COUNT(*) FROM ratings;
-- Total number of rows in director_mapping = 7997

SELECT COUNT(*) FROM role_mapping;
-- Total number of rows in director_mapping = 15615
...
-- Result:
-- country, worldwide_gross_income, languages, and production_company are the columns that has NULL values in movies table
...
-- there are total 13 types of genre of movies
...
-- Drama genre had produced the highest number of movies of 4285 numbers.
...
-- The rank of "Thriller" genre with regards to movie production is 3rd. 
...
-- Top 3 actors are as follows: 1. Vijay Sethupati, 2. Fahadh Faasil, 3. Yogi Babu.
...
/*Top 5 actresses are as follows: 1. Taapsee Pannu, 2. Kriti Sanon, 3. Divya Dutta,
4. Shraddha Kapoor, and 5. Kriti Kharbanda
*/
...
/* Star Cinema and Twentieth Cenury Fox are the top two production company 
...
/* Top 3 actresses based on number of Super Hit movies in Drama genre are: 1. Parvathy Thiruvothu,
	2. Susan Brown, 3. Amanda Lawrence */
